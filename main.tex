...
\newcommand{\stuid}{3210000000}		  		 % 学生学号
...
\newcommand{\stuengtitle}{English Title}			% 毕设英文题目
...
\setmainfont[Path=fonts/]{times.ttf}					% 缺省英文字体为Times New Roman
...
\renewcommand{\theequation}{\arabic{section}.\arabic{equation}}  % 公式的编号格式
% 插入表格宏包
\usepackage{booktabs}
...
\begin{document}
    ...
    % 考核表
    \newpage
    \input{contents/examination.tex}
